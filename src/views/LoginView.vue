    ...
    <div class="container-login100">
        <Transition name="login">
            <div v-if="showLogin" class="wrap-login100">
                ...
                <h4 class="title-login app-pointer">{{ APP_TITLE }} <span class="app-desc">{{ APP_DESCRIPTION }}</span></h4>
                <div class="pl-5 pr-5">
                    <hr class="red">
                </div>
                <form class="login100-form">
                    ...
                    <div class="col-md-12 p-0">
                        ...
                        <input type="email" id="usuario" v-model="loginForm.username" class="form-control"
                            autocomplete="off" placeholder="Nombre de usuario">
                        <small class="app-validation" v-if="errors && errors.username">{{ errors.username }}</small>
                    </div>
                    <div class="col-md-12 p-0">
                        <label for="password" class="form-label">Contraseña</label>
                        <input type="password" v-model="loginForm.password" id="password" class="form-control"
                            autocomplete="off" placeholder="Contraseña">
                        <small class="app-validation" v-if="errors && errors.password">{{ errors.password }}</small>
                    </div>
                    <div class="forgot-pass">
                        <a href="#">
                            ¿Ha olvídado tu contraseña?
                        </a>
                    </div>
